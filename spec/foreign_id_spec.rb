...
describe Echonest::ForeignId do

    it 'should parse the catalog id' do
      foreign_id = Echonest::ForeignId.new(catalog: "musicbrainz", foreign_id: "musicbrainz:artist:6fe07aa5-fec0-4eca-a456-f29bff451b04")
    ...
    it 'should parse an array of results' do
      ...
      Echonest::ForeignId.parse_array(results).count.should be 2
    end
